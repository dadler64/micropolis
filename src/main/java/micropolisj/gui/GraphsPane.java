...
public class GraphsPane extends JPanel
    ...
    static ResourceBundle strings = MainWindow.guiStrings;
    Micropolis engine;
    ...
    private JToggleButton makeDataBtn(GraphData graph) {
        ...
        ImageIcon icon1 = new ImageIcon(getClass().getResource("/images/" + icon1name));
        ImageIcon icon2 = new ImageIcon(getClass().getResource("/images/" + icon2name));
    ...
    class GraphArea extends JComponent {
        ...
        public void paintComponent(Graphics gr1) {
            ...
            int unitPeriod = isOneTwenty ? 12 * Micropolis.CENSUS_RATE : Micropolis.CENSUS_RATE;
            ...
            for (int i = 0; i < 120; i++) {
                ...
                if (t % hashPeriod == 0) {
                    // year
                    int year = 1900 + (t / (12 * Micropolis.CENSUS_RATE));
