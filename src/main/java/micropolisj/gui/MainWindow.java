...
public class MainWindow extends JFrame implements Micropolis.Listener, EarthquakeListener {
    ...
    static ResourceBundle guiStrings = ResourceBundle.getBundle("strings/GuiStrings");
    static final String PRODUCT_NAME = guiStrings.getString("PRODUCT");

    static {
        appIcon = new ImageIcon(MainWindow.class.getResource("/images/micropolisj.png"));
    }
    ...
    JLabel currentToolCostLabel;
    Map<MicropolisTool, JToggleButton> toolButtons;
    ...
    public MainWindow(Micropolis engine) {
        ...
        JMenu zonesMenu = new JMenu(guiStrings.getString("menu.zones"));
        ...
        JMenu overlaysMenu = new JMenu(guiStrings.getString("menu.overlays"));
    ...
    public static String formatFunds(int funds) {
        return MessageFormat.format(
                guiStrings.getString("funds"), funds
        );
    }
        ...
        if (needsSaved()) {
            ...
            try {
                int rv = JOptionPane.showConfirmDialog(
                        this,
                        guiStrings.getString("main.save_query"),
                        PRODUCT_NAME,
    ...
    JComponent makeDateFunds() {
        ...
        pane.add(new JLabel(guiStrings.getString("main.date_label")), c0);
        dateLabel = new JLabel();
        pane.add(dateLabel, c1);

        c0.gridy = c1.gridy = 1;

        pane.add(new JLabel(guiStrings.getString("main.funds_label")), c0);
        fundsLabel = new JLabel();
        pane.add(fundsLabel, c1);

        c0.gridy = c1.gridy = 2;

        pane.add(new JLabel(guiStrings.getString("main.population_label")), c0);
        populationLabel = new JLabel();
        pane.add(populationLabel, c1);

        return pane;
    }

    private void setupKeys(JMenu menu, String prefix) {
        if (guiStrings.containsKey(prefix + ".key")) {
            String mnemonic = guiStrings.getString(prefix + ".key");
            menu.setMnemonic(
    ...
    private void setupKeys(JMenuItem menuItem, String prefix) {
        ...
        if (guiStrings.containsKey(prefix + ".shortcut")) {
            String shortcut = guiStrings.getString(prefix + ".shortcut");
    ...
    private void makeMenu() {
        ...
        JMenu gameMenu = new JMenu(guiStrings.getString("menu.game"));
        setupKeys(gameMenu, "menu.game");
        menuBar.add(gameMenu);

        JMenuItem menuItem;
        menuItem = new JMenuItem(guiStrings.getString("menu.game.new"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.game.load"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.game.save"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.game.save_as"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.game.exit"));
        ...
        JMenu optionsMenu = new JMenu(guiStrings.getString("menu.options"));
        setupKeys(optionsMenu, "menu.options");
        menuBar.add(optionsMenu);

        JMenu levelMenu = new JMenu(guiStrings.getString("menu.difficulty"));
        ...
        for (int i = GameLevel.MIN_LEVEL; i <= GameLevel.MAX_LEVEL; i++) {
            final int level = i;
            menuItem = new JRadioButtonMenuItem(guiStrings.getString("menu.difficulty." + level));
        ...
        autoBudgetMenuItem = new JCheckBoxMenuItem(guiStrings.getString("menu.options.auto_budget"));
        ...
        autoBulldozeMenuItem = new JCheckBoxMenuItem(guiStrings.getString("menu.options.auto_bulldoze"));
        ...
        disastersMenuItem = new JCheckBoxMenuItem(guiStrings.getString("menu.options.disasters"));
        ...
        soundsMenuItem = new JCheckBoxMenuItem(guiStrings.getString("menu.options.sound"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.options.zoom_in"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.options.zoom_out"));
        ...
        JMenu disastersMenu = new JMenu(guiStrings.getString("menu.disasters"));
        setupKeys(disastersMenu, "menu.disasters");
        menuBar.add(disastersMenu);

        menuItem = new JMenuItem(guiStrings.getString("menu.disasters.MONSTER"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.disasters.FIRE"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.disasters.FLOOD"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.disasters.MELTDOWN"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.disasters.TORNADO"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.disasters.EARTHQUAKE"));
        ...
        JMenu priorityMenu = new JMenu(guiStrings.getString("menu.speed"));
        setupKeys(priorityMenu, "menu.speed");
        menuBar.add(priorityMenu);

        priorityMenuItems = new EnumMap<Speed, JMenuItem>(Speed.class);
        menuItem = new JRadioButtonMenuItem(guiStrings.getString("menu.speed.SUPER_FAST"));
        ...
        menuItem = new JRadioButtonMenuItem(guiStrings.getString("menu.speed.FAST"));
        ...
        menuItem = new JRadioButtonMenuItem(guiStrings.getString("menu.speed.NORMAL"));
        ...
        menuItem = new JRadioButtonMenuItem(guiStrings.getString("menu.speed.SLOW"));
        ...
        menuItem = new JRadioButtonMenuItem(guiStrings.getString("menu.speed.PAUSED"));
        ...
        JMenu windowsMenu = new JMenu(guiStrings.getString("menu.windows"));
        setupKeys(windowsMenu, "menu.windows");
        menuBar.add(windowsMenu);

        menuItem = new JMenuItem(guiStrings.getString("menu.windows.budget"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.windows.evaluation"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.windows.graph"));
        ...
        JMenu helpMenu = new JMenu(guiStrings.getString("menu.help"));
        setupKeys(helpMenu, "menu.help");
        menuBar.add(helpMenu);

        menuItem = new JMenuItem(guiStrings.getString("menu.help.launch-translation-tool"));
        ...
        menuItem = new JMenuItem(guiStrings.getString("menu.help.about"));
    ...
    void makeClean() {
        ...
        if (currentFile != null) {
            ...
            setTitle(MessageFormat.format(guiStrings.getString("main.caption_named_city"), fileName));
        } else {
            setTitle(guiStrings.getString("main.caption_unnamed_city"));
        }
    }
    ...
    private boolean onSaveCityClicked() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, e, guiStrings.getString("main.error_caption"),
    ...
    private boolean onSaveCityAsClicked() {
        ...
        try {
            ...
            FileNameExtensionFilter filter1 = new FileNameExtensionFilter(guiStrings.getString("cty_file"), EXTENSION);
    ...
    private JToggleButton makeToolBtn(final MicropolisTool tool) {
        String iconName = guiStrings.containsKey("tool." + tool.name() + ".icon") ?
                guiStrings.getString("tool." + tool.name() + ".icon") :
                "/graphics/tools/" + tool.name().toLowerCase() + ".png";
        String iconSelectedName = guiStrings.containsKey("tool." + tool.name() + ".selected_icon") ?
                guiStrings.getString("tool." + tool.name() + ".selected_icon") :
                iconName;
        String tipText = guiStrings.containsKey("tool." + tool.name() + ".tip") ?
                guiStrings.getString("tool." + tool.name() + ".tip") :
                tool.name();

        JToggleButton btn = new JToggleButton();
//        System.out.println("Icon Name: /resources/images" + iconName);
//        System.out.println(MainWindow.class.getResource("/images" + iconName).toString());
        btn.setIcon(new ImageIcon(MainWindow.class.getResource("/images" + iconName)));
        btn.setSelectedIcon(new ImageIcon(MainWindow.class.getResource("/images" + iconSelectedName)));
    ...
    private JToolBar makeToolbar() {
        ...
        JToolBar toolBar = new JToolBar(guiStrings.getString("main.tools_caption"), JToolBar.VERTICAL);
        ...
        gridBox.add(currentToolLabel, c);

        c.gridy = 1;
        c.insets = new Insets(0, 0, 12, 0);
        currentToolCostLabel = new JLabel(" ");
        gridBox.add(currentToolCostLabel, c);
    ...
    private void selectTool(MicropolisTool newTool) {
        ...
        currentToolLabel.setText(
                guiStrings.containsKey("tool." + currentTool.name() + ".name") ?
                        guiStrings.getString("tool." + currentTool.name() + ".name") :
                        currentTool.name()
        );

        int cost = currentTool.getToolCost();
        currentToolCostLabel.setText(cost != 0 ? formatFunds(cost) : " ");
    }
    ...
    private void updateDateLabel() {
        dateLabel.setText(formatGameDate(engine.cityTime));

        NumberFormat nf = NumberFormat.getInstance();
        populationLabel.setText(nf.format(getEngine().getCityPopulation()));
    }
    ...
    private void showErrorMessage(Throwable e) {
        ...
        int rv = JOptionPane.showOptionDialog(this, e,
                guiStrings.getString("main.error_unexpected"),
                JOptionPane.DEFAULT_OPTION,
                JOptionPane.ERROR_MESSAGE,
                null,
                new String[]{
                        guiStrings.getString("main.error_show_stacktrace"),
                        guiStrings.getString("main.error_close"),
                        guiStrings.getString("main.error_shutdown")
                },
                1
        );
        if (rv == 0) {
        ...
        if (rv == 2) {
            rv = JOptionPane.showConfirmDialog(
                    this,
                    guiStrings.getString("error.shutdown_query"),
                    guiStrings.getString("main.error_unexpected"),
    ...
    private void reloadFunds() {
        fundsLabel.setText(formatFunds(getEngine().budget.totalFunds));
    }
    ...
    private JMenuItem makeMapStateMenuItem(String stringPrefix, final MapState state) {
        String caption = guiStrings.getString(stringPrefix);
    ...
    private void setMapLegend(MapState state) {
        ...
        if (guiStrings.containsKey(k)) {
            String iconName = guiStrings.getString(k);
    ...
    private void onAboutClicked() {
        ...
        String versionStr = MessageFormat.format(guiStrings.getString("main.version_string"), version);
        ...
        JLabel appDetailsLbl = new JLabel(guiStrings.getString("main.about_text"));
        JComponent[] inputs = new JComponent[]{appNameLbl, appDetailsLbl};
        JOptionPane.showMessageDialog(this,
                inputs,
                guiStrings.getString("main.about_caption"),
