...
public class ShipSprite extends Sprite
{
	...
	static int [] BtClrTab = { RIVER, CHANNEL, POWER_BASE, POWER_BASE +1,
			RAIL_BASE, RAIL_BASE +1, BRWH, BRWV };
	...
	boolean tryOther(int tile, int oldDir, int newDir)
	{
		...
		return (tile == POWER_BASE || tile == POWER_BASE +1 ||
			tile == RAIL_BASE || tile == RAIL_BASE +1);
	}
